...
const routes: Routes = [
    ...
    { path: "availableleagueletsplay", component: AvailableleagueletsplayComponent },
    { path: "joinleague", component: JoinleagueComponent },
    { path: "headtoheadsummary", component: HeadtoheadsummaryComponent },
    { path: "headtoheadsummary/:weekId/:player1Id/:player2Id", component: HeadtoheadsummaryComponent },
    ...
    { path: "contactofficepickempool", component: ContactofficepickempoolComponent },
